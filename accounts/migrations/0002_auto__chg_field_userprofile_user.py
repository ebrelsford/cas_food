...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field schools_following on 'UserProfile'
        db.create_table('accounts_userprofile_schools_following', (
        ...
        db.create_unique('accounts_userprofile_schools_following', ['userprofile_id', 'school_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field schools_following on 'UserProfile'
        db.delete_table('accounts_userprofile_schools_following')
    ...
    models = {
        'accounts.userprofile': {
            ...
            'schools_following': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['schools.School']", 'symmetrical': 'False'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 10, 22, 34, 40, 427454)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 10, 22, 34, 40, 427322)'}),
