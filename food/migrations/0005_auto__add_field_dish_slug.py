...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Dish.slug'
        db.add_column('food_dish', 'slug', self.gf('django.db.models.fields.SlugField')(default='', max_length=132, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Dish.slug'
        db.delete_column('food_dish', 'slug')
