...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field callouts on 'Dish'
        db.create_table('food_dish_callouts', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('dish', models.ForeignKey(orm['food.dish'], null=False)),
            ('callout', models.ForeignKey(orm['food.callout'], null=False))
        ))
        db.create_unique('food_dish_callouts', ['dish_id', 'callout_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field callouts on 'Dish'
        db.delete_table('food_dish_callouts')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 4, 13, 42, 52, 88519)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 4, 13, 42, 52, 88383)'}),
