...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Dish.school_type'
        db.add_column('food_dish', 'school_type', self.gf('django.db.models.fields.CharField')(default='elementary', max_length=32, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Dish.school_type'
        db.delete_column('food_dish', 'school_type')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 15, 15, 26, 2, 156522)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 15, 15, 26, 2, 156383)'}),
