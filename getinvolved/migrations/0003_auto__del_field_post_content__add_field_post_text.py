...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('getinvolved_post', 'content')

        # Adding field 'Post.text'
        db.add_column('getinvolved_post', 'text', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('getinvolved_post', 'text')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 9, 12, 2, 29, 839812)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 9, 12, 2, 29, 839633)'}),
