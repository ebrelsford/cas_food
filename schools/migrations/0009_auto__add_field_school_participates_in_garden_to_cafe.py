...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'School.participates_in_garden_to_cafe'
        db.add_column('schools_school', 'participates_in_garden_to_cafe', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'School.participates_in_garden_to_cafe'
        db.delete_column('schools_school', 'participates_in_garden_to_cafe')
