...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        "For all string fields, use title() to make them more readable."
        for school in orm.School.objects.all():
            school.name = school.name.title()
            school.address = school.address.title()
            school.city = school.city.title()
            school.save()


    def backwards(self, orm):
        "For all string fields, use upper() to make them ugly."
        for school in orm.School.objects.all():
            school.name = school.name.upper()
            school.address = school.address.upper()
            school.city = school.city.upper()
            school.save()
