...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('schools_school', 'slug', self.gf('django.db.models.fields.SlugField')(default='', max_length=260, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'School.slug'
        db.delete_column('schools_school', 'slug')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 30, 23, 22, 7, 500294)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 30, 23, 22, 7, 500109)'}),
