...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        "Add slug for each school."
        for school in orm.School.objects.all():
            school.slug = slugify(orm.School, school.name)
            school.save()

    def backwards(self, orm):
        "Remove slugs."
        orm.School.objects.all().update(slug='')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 30, 23, 3, 20, 48494)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 30, 23, 3, 20, 48345)'}),
