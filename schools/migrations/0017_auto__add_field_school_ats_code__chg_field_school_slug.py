...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('schools_school', 'ats_code', self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True), keep_default=False)

        # Changing field 'School.slug'
        db.alter_column('schools_school', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=260))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'School.slug'
        db.alter_column('schools_school', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 2, 2, 6, 5, 798535)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 2, 2, 6, 5, 798398)'}),
