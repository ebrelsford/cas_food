...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Rating'
        db.create_table('tray_rating', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('added_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='tray_rating_added', null=True, to=orm['auth.User'])),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='tray_rating_updated', null=True, to=orm['auth.User'])),
            ('tray', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tray.Tray'])),
            ('points', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('tray', ['Rating'])


    def backwards(self, orm):
        
        # Deleting model 'Rating'
        db.delete_table('tray_rating')
